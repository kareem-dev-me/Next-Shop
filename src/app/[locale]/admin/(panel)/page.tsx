...
export default async function AdminDashboardPage() {
  ...
  const cards = [
    { key: "products", value: adminStats.products },
    { key: "orders", value: adminStats.orders },
    { key: "customers", value: adminStats.customers },
    { key: "revenue", value: `$${adminStats.revenue.toLocaleString()}` },
  ] as const;
